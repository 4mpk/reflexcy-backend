...
{
    /// <inheritdoc />
    public partial class Added_DataForm : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemplateSystemName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ProjectLinks = table.Column<string>(type: "nvarchar(max)", nullable: false),
